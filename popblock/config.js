...
const config = {
  ...
  'popup-hosts': [
    ...
    'mail.google.com', 'doubleclick.net','bitcotasks.com'
  ],
  // popup blocker is disabled in the following hostname tabs
  'top-hosts': ['github.com', 'twitter.com', 'webextension.org', 'google.com', 'paypal.com','bitcotasks.com'],
